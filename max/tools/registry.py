...
FILE_TOOL_SCHEMAS = [
    {
        ...
        "function": {
            "name": "read_file",
            "description": (
                "Read a text file's contents. Allowed anywhere under the Max project, "
    ...
    },
    {
        ...
        "function": {
            "name": "write_file",
            "description": "Write (or overwrite) a text file within the Max project directory only.",
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            "name": "list_dir",
            "description": (
                "List files in a directory. Allowed anywhere under the Max project, "
                "Desktop, Documents, or Downloads — anywhere else is refused."
            ),
            "parameters": {
                "type": "object",
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "the Max project directory. Use this to find a file before reading it "
    ...
    },
    {
        ...
        "function": {
            "name": "run_shell",
            "description": "Run a shell command in the Max project directory.",
            "parameters": {
                "type": "object",
